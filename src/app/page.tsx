            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 items-start">
              ...
              <motion.div variants={FADE_UP_ANIMATION_VARIANTS} className="p-8 rounded-3xl bg-white border border-brand-border shadow-sm flex flex-col h-full">
                ...
                <div className="mb-8 flex items-baseline gap-2">
                  <span className="text-4xl font-bold text-brand-dark">$99.99</span>
                  <span className="text-slate-400 font-medium"> <span className="text-xs text-slate-400 opacity-75">+ domain fee</span></span>
                </div>
                  ...
                  <div className="relative p-8 rounded-[23px] bg-white flex flex-col h-full">
                    ...
                    <div className="mb-8 flex flex-col gap-1">
                      <div className="flex items-baseline gap-2">
                        <span className="text-4xl font-bold text-brand-dark">$99.99</span>
                        <span className="text-slate-400 font-medium whitespace-nowrap"><span className="text-xs text-slate-400 opacity-75">+ domain fee</span></span>
                      </div>
                      <span className="text-brand-cyan font-bold text-sm">+ $49.99 /mo</span>
                    </div>
                    <ul className="space-y-4 mb-8 flex-1">
              ...
              <motion.div variants={FADE_UP_ANIMATION_VARIANTS} className="p-8 rounded-3xl bg-white border border-brand-border shadow-sm flex flex-col h-full">
                ...
                <div className="mb-8">
                  <span className="text-4xl font-bold text-brand-dark">$49.99</span>
      ...
      <footer className="border-t border-brand-border py-12 px-6 relative z-10 bg-white/50 backdrop-blur-sm">
        ...
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-8">
          ...
          <div className="flex items-center gap-6">
            <Link aria-label="Instagram" href="#" className="text-slate-500 hover:text-brand-blue transition-colors">
              <Instagram className="w-5 h-5" />
            </Link>
            <Link aria-label="Facebook" href="#" className="text-slate-500 hover:text-brand-blue transition-colors">
            ...
            <Link aria-label="LinkedIn" href="#" className="text-slate-500 hover:text-brand-blue transition-colors">
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "logo": "https://aivanguardd.com/Logo.jpg",
